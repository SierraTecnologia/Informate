...
namespace Informate\Providers\Exemplos;
...
class HomeServiceProvider extends ServiceProvider
{
    ...
    protected function registerAppServices(): void
    {
        ...
        $this->app->bind(
            \Informate\Services\Image\Contracts\ImageProcessor::class,
            \Informate\Services\Image\ImagineImageProcessor::class
        );

        $this->app->when(\Informate\Services\Image\ImagineImageProcessor::class)
            ->needs('$config')
        ...
        $this->app->bind(
            \Informate\Services\Writelabel\Manifest\Contracts\Manifest::class,
            \Informate\Services\Writelabel\Manifest\AppManifest::class
        );

        $this->app->bind(
            \Informate\Services\Writelabel\SiteMap\Contracts\SiteMapBuilder::class,
            \Informate\Services\Writelabel\SiteMap\AppSiteMapBuilder::class
        );

        $this->app->bind(
            \Informate\Services\Writelabel\Rss\Contracts\RssBuilder::class,
            \Informate\Services\Writelabel\Rss\AppRssBuilder::class
        );
