...
class CreateInfraTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('infra_services', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('infra_ambientes', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
        ...
        Schema::create('infra_ssh_keys', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->string('slug')->nullable();
        ...
        Schema::create('infra_computers', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
        ...
        Schema::create('infra_loggers', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('infra_deploys', function (Blueprint $table) {
            $table->increments('id');
         ...
         * DOminios
         */
        Schema::create('infra_domains', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->string('url')->nullable();
            $table->integer('status')->default(1);
        ...
        Schema::create('infra_dominio_rules', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->string('url')->nullable();
            $table->integer('status')->default(1);
         ...
         * Bancos de Dados
         */
        Schema::create('infra_databases', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('infra_database_collections', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
        ...
        Schema::create('infra_database_tables', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
        ...
        Schema::create('infra_database_columns', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
