...
class CreateCodeTables extends Migration
{
    ...
    public function up()
    {
        ...
        Schema::create('code_sprints', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
        ...
        Schema::create('code_resolutions', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('type')->nullable();
            $table->integer('status')->default(1);
        ...
        Schema::create('code_stages', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->string('type')->nullable();
            $table->integer('status')->default(1);
        ...
        Schema::create('code_fields', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->timestamps();
        });

        Schema::create('code_issue_fields', function (Blueprint $table) {
            $table->increments('id');
            $table->string('value');
        ...
        Schema::create('code_issue_relation_types', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name');
            $table->timestamps();
        });

        Schema::create('code_issue_links', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('code_libs', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('code_project_commits', function (Blueprint $table) {
            $table->increments('id');
        ...
        Schema::create('code_project_branchs', function (Blueprint $table) {
            $table->increments('id');
            $table->string('name')->nullable();
            $table->integer('code_project_commit_id')->nullable();
            $table->integer('code_project_id')->nullable();
